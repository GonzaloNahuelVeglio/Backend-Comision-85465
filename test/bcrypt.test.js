...
describe("Probar las funciones createHash y passwordValidation", function(){
    it("El metodo createHash debe devolver un valor diferente al password", async function(){
